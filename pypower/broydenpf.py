# Copyright (c) 1996-2017 PSERC. All rights reserved.
...
def broydenpf(Ybus, Sbus, V0, ref, pv, pq, ppopt=None):
    """Solves the power flow using a Broyden's method.
    ...
    while (not converged and i < max_it):
        ...
        F = r_[  mis[pv].real,
                 mis[pq].real,
                 mis[pq].imag  ]
        #Broyden method to modfiy the Jacobian mat
        #It accerates computation but decreases converge chance 
        J=sparse(J+ ((F-F0)-J*dx)*dx.T/(dx).T*dx)
